...
function traduction() {
  switch (liste.value) {
    case "en":
      ...
      window.localStorage.setItem("chargementLangue", "en");
    ...
    case "fr":
      ...
      window.localStorage.setItem("chargementLangue", "fr");
...
window.localStorage.getItem("chargementLangue");
